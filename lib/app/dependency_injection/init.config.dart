...
import 'package:task_repository/task_repository.dart' as _i20;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i20.TaskRepository>(() => taskModule.taskRepository(
          gh<_i12.FirebaseFirestore>(),
          gh<_i13.FirebaseFunctions>(),
          gh<_i3.AuthenticationRepositoryContract>(),
        ));
    gh.factory<_i21.TasksCubit>(
        () => taskModule.taskCubit(gh<_i20.TaskRepository>()));
    gh.lazySingleton<_i22.AuthenticationCubit>(() => authenticationModule
    ...
    gh.lazySingleton<_i23.IntegrationsCubit>(
