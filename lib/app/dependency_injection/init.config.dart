...
import 'package:blueprint/authentication/state_management/sign_up_cubit/sign_up_cubit.dart'
    as _i18;
import 'package:blueprint/blueprint/module/blueprint_module.dart' as _i31;
...
import 'package:blueprint/core/module/firebase_module.dart' as _i25;
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i6.GoogleCalendarService>(() =>
        calendarModule.googleCalendarService(gh<
            _i8.PlatformIntegrationStorage<_i6.GoogleCalendarPlatform,
                _i6.GoogleCalendarIntegration>>()));
    gh.lazySingleton<_i15.IntegrationsRepository>(
    ...
    gh.factory<_i19.TasksCubit>(
        () => taskModule.taskCubit(gh<_i15.IntegrationsRepository>()));
    ...
    gh.lazySingleton<_i21.AvailablePlatformsCubit>(() => integrationsModule
        .availablePlatformsCubit(gh<_i15.IntegrationsRepository>()));
    gh.lazySingleton<_i8.CalendarRepository>(() =>
        calendarModule.calendarRepository(gh<_i6.GoogleCalendarService>()));
    gh.lazySingleton<_i22.IntegrationsCubit>(
...
class _$BlueprintModule extends _i31.BlueprintModule {}
