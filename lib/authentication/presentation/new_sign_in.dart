...
class _NewSignInView extends StatefulWidget {
  const _NewSignInView({
    required this.onResult,
  });
  ...
  @override
  State<_NewSignInView> createState() => _NewSignInViewState();
}

class _NewSignInViewState extends State<_NewSignInView> {
