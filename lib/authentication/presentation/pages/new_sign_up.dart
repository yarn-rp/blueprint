...
class _NewSignUpView extends StatefulWidget {
  const _NewSignUpView({
    required this.onResult,
  });
  ...
  @override
  State<_NewSignUpView> createState() => _NewSignUpViewState();
}

class _NewSignUpViewState extends State<_NewSignUpView> {
